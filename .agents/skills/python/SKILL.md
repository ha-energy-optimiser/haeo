---
name: python
description: Python coding standards for HAEO — modern syntax, type hints, async patterns, error handling, logging, docstrings, and lint suppression rules. Use when writing or modifying any Python code in this repository.
---
