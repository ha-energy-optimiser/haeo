---
name: config-flow
description: Config flow and subentry flow development — element configuration UI, schema generation, sections, validation timing, unique IDs, and flow error handling. Use when working under flows/ or config_flow.py, or when changing how elements are configured in the Home Assistant UI.
---
