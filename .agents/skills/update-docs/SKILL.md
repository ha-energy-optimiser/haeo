---
name: update-docs
description: Update documentation to match the code changes on the current branch. Use after implementing a feature or refactor, when asked to update the docs, or when a change affects user guides, developer guides, modeling docs, or element documentation.
---
